...
import (
	...
	black "github.com/xblackfury/black/types"
)
...
func GetTransferSenderRecipient(packet channeltypes.Packet) (
	...
	// and change the bech32 human readable prefix (HRP) of the sender to `did:fury:`
	...
	// and change the bech32 human readable prefix (HRP) of the recipient to `did:fury:`
