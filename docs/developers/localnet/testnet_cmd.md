...
preparing test network with chain-id "black_1276974-1"
...
```bash
blackd keys add test --recover
```

Check the balance of the account address:

```bash
blackd q bank balances ADDRESS
```
