...
Learn about the encoding formats used on Black. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Black does not
...
allows for quick reconstruction of encoded data. Black uses RLP to encode/decode Ethereum
