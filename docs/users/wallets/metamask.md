...
Connect your Metamask wallet with Black. {synopsis}
...
::: tip
If you are planning on developing on Black locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../validators/quickstart/run_node.md), or follow the instructions in the [GitHub repository](https://github.com/xblackfury/black/).
:::
...
3. Click the `Connect Wallet` button under `Black Testnet`
...
```bash
blackd keys unsafe-export-eth-key dev0
```
